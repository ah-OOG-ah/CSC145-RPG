...
namespace ITiers {
    ...
    // Weapons
    static const std::vector<std::shared_ptr<Weapon>> noWeapons { nothing };
    static const std::vector<std::shared_ptr<Weapon>> basicWeapons { sword, spear, whip, staff, nothing };
