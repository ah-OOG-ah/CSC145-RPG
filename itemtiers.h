...
namespace ITiers {
    ...
    static const std::vector<StatusItem> basicRoids = {roids};
    static const std::vector<StatusItem> allRoids = {roids, roids, superRoids};
    ...
    static const std::vector<Armor *> noArmor = {nullptr};
